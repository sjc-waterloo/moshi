...
def clone_bench_repo(args):
	...
	repo_url = args.repo_url or 'http://gitlab.moshimori.com/steven/bench.git'
...
def get_passwords(ignore_prompt=False):
	if not ignore_prompt:
		mysql_root_password, admin_password = 'root', 'admin'
		pass_set = True
...
def parse_commandline_args():
	...
	parser.add_argument('--site', dest='site', action='store', default='127.0.0.1',
